 ...
 616:	73 10                	jae    628 <free+0x38>
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 647:	5e                   	pop    %esi
 648:	5f                   	pop    %edi
 649:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
 ...
 702:	e8 e9 fe ff ff       	call   5f0 <free>
  return freep;
 707:	8b 15 80 0a 00 00    	mov    0xa80,%edx
 ...
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf 84 0a 00 00       	mov    $0xa84,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 772:	00 00 00 
    if(p->s.size >= nunits){
