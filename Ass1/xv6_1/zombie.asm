 ...
 5e6:	73 10                	jae    5f8 <free+0x38>
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	a3 20 0a 00 00       	mov    %eax,0xa20
}
 617:	5e                   	pop    %esi
 618:	5f                   	pop    %edi
 619:	5d                   	pop    %ebp
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 20 0a 00 00       	mov    %eax,0xa20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 20 0a 00 00    	mov    0xa20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6a9:	8b 3d 20 0a 00 00    	mov    0xa20,%edi
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	8b 15 20 0a 00 00    	mov    0xa20,%edx
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf 24 0a 00 00       	mov    $0xa24,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 24 0a 00 00 24 	movl   $0xa24,0xa24
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 28 0a 00 00 00 	movl   $0x0,0xa28
 742:	00 00 00 
    if(p->s.size >= nunits){
