 ...
 336:	89 d3                	mov    %edx,%ebx
{
 ...
 379:	0f b6 92 94 07 00 00 	movzbl 0x794(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 574:	eb 1a                	jmp    590 <printf+0x1a0>
          s = "(null)";
 576:	bb 8c 07 00 00       	mov    $0x78c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 40 0a 00 00       	mov    0xa40,%eax
{
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 40 0a 00 00    	mov    0xa40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	8b 15 40 0a 00 00    	mov    0xa40,%edx
 ...
 704:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 707:	89 15 40 0a 00 00    	mov    %edx,0xa40
}
