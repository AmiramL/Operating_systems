...
free(void *ap)
{
 ...
 8e1:	a1 10 0e 00 00       	mov    0xe10,%eax
{
 ...
 906:	73 10                	jae    918 <free+0x38>
{
 ...
 931:	5b                   	pop    %ebx
  freep = p;
 932:	a3 10 0e 00 00       	mov    %eax,0xe10
}
 937:	5e                   	pop    %esi
 938:	5f                   	pop    %edi
 939:	5d                   	pop    %ebp
 ...
 957:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 95a:	a3 10 0e 00 00       	mov    %eax,0xe10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 97c:	8b 3d 10 0e 00 00    	mov    0xe10,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9c9:	8b 3d 10 0e 00 00    	mov    0xe10,%edi
 ...
 9f2:	e8 e9 fe ff ff       	call   8e0 <free>
  return freep;
 9f7:	8b 15 10 0e 00 00    	mov    0xe10,%edx
 ...
 a47:	0e 00 00 
    base.s.size = 0;
 a4a:	bf 14 0e 00 00       	mov    $0xe14,%edi
    base.s.ptr = freep = prevp = &base;
 a4f:	c7 05 14 0e 00 00 14 	movl   $0xe14,0xe14
 a56:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a59:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a5b:	c7 05 18 0e 00 00 00 	movl   $0x0,0xe18
 a62:	00 00 00 
    if(p->s.size >= nunits){
