 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 a0 0a 00 00       	mov    %eax,0xaa0
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d a0 0a 00 00    	mov    0xaa0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	8b 3d a0 0a 00 00    	mov    0xaa0,%edi
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
 ...
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf a4 0a 00 00       	mov    $0xaa4,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 a4 0a 00 00 a4 	movl   $0xaa4,0xaa4
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
