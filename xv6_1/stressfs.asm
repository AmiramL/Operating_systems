 ...
 6f6:	73 10                	jae    708 <free+0x38>
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	a3 60 0b 00 00       	mov    %eax,0xb60
}
 727:	5e                   	pop    %esi
 728:	5f                   	pop    %edi
 729:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7b9:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
 ...
 7e2:	e8 e9 fe ff ff       	call   6d0 <free>
  return freep;
 7e7:	8b 15 60 0b 00 00    	mov    0xb60,%edx
 ...
 814:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 817:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 ...
 82f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 60 0b 00 00 64 	movl   $0xb64,0xb60
 837:	0b 00 00 
    base.s.size = 0;
 83a:	bf 64 0b 00 00       	mov    $0xb64,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 846:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
